...
For analytics, I use [GoatCounter](https://www.goatcounter.com/), because it's simple, free (to be more precise, [donation-supported](https://github.com/sponsors/arp242/)), and privacy-friendly. I've heard good things about [Umami](https://umami.is/), and I previously used the free trial of [Simple Analytics](https://www.simpleanalytics.com/) but stopped once they asked for money, lol.

I finally got my own domain from [Porkbun](https://porkbun.com/) and use their DNS services, but I continue to use GitHub Pages for hosting. I might migrate my DNS to [Cloudflare](https://www.cloudflare.com/) at some point, but I'm lazy.
